...
var (
	...
	ErrLeaveInvalidDates        = errors.New("start date cannot be after end date")
	ErrLeaveNoWorkingDay        = errors.New("leave must include at least one working day")
	...
	ErrCheckOutBeforeCheckIn    = errors.New("check-out time precedes check-in")
